                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="edit/basics">
                      ...
                      @if (auth()->user()->current_img)
                        ...
                        <div class="img-thumbnail rounded float-left w-50" style="background-image: url('https://5th-rgt-profile-photos.s3.us-east-2.amazonaws.com/{{ auth()->user()->current_img }}?t=<?php echo(time()); ?>'); background-size:cover; background-position: center; min-width: 100px; min-height: 300px"></div>
                      @else
                      ...
                      @if (auth()->user()->veteran_img)
                        ...
                        <div class="img-thumbnail rounded float-left w-50" style="background-image: url('https://5th-rgt-profile-photos.s3.us-east-2.amazonaws.com/{{ auth()->user()->veteran_img }}?t=<?php echo(time()); ?>'); background-size:cover; background-position: center; min-width: 100px; min-height: 300px"></div>
                      @else
